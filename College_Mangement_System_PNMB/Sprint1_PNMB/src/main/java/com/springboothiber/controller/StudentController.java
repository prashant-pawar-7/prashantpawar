...
public class StudentController {
	...
	@GetMapping("/Bycourse/{cname}")
	public List<Student> FindByCourseName(@PathVariable("cname") String cname){
		
	return	ss.getAllStudents().stream().filter(s->s.getScourse().getCname().equalsIgnoreCase(cname))
